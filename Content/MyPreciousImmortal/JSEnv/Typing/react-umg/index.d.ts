...
export class MovieRenderDebugWidget extends React.Component<MovieRenderDebugWidgetProps> {}

export interface MoviePipelineBurnInWidgetProps extends UserWidgetProps {
}

export class MoviePipelineBurnInWidget extends React.Component<MoviePipelineBurnInWidgetProps> {}
...
export interface WBP_Lanucher_CProps extends UserWidgetProps {
    UberGraphFrame?: PointerToUberGraphFrame;
}

export class WBP_Lanucher_C extends React.Component<WBP_Lanucher_CProps> {}

export interface SKEL_WBP_Lanucher_CProps extends UserWidgetProps {
    UberGraphFrame?: PointerToUberGraphFrame;
}
