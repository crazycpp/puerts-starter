...
void FTypeScriptDeclarationGenerator::GenTypeScriptDeclaration()
{
    ...
    FFileHelper::SaveStringToFile(ToString(), *(FPaths::ProjectContentDir() / TEXT("MyPreciousImmortal/JSEnv/Typing/ue/ue.d.ts")));
}
...
export var ReactUMG : TReactUMG;
    ...
    FFileHelper::SaveStringToFile(ToString(), *(FPaths::ProjectContentDir() / TEXT("MyPreciousImmortal/JSEnv/Typing/react-umg/index.d.ts")));
    FFileHelper::SaveStringToFile(Components, *(FPaths::ProjectContentDir() / TEXT("MyPreciousImmortal/JSEnv/JavaScript/react-umg/components.js")));
}
